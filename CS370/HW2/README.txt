...
Makefile
    This is the file that will allow you wo quickly compile and remove compiled code. You will not have to type gcc and the output names anymore. It uses all of the flags that I normally use.
