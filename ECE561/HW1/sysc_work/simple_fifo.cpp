   ...
   public:
     ...
     void main()
     {
       ...
       while (*str){
         ...
         //if(out->nb_write(*str))//doesnt block, instead returns false if full
...
class consumer : public sc_module
{
   public:
     ...
     void main()
     {
       //cout << "Consumer Main" << endl;
       char c;
       cout << endl << endl;

       while (true) {
         //cout << "consumer while loop" << endl;
         in->read(c);
         cout << c << flush;
...
class top : public sc_module
{
   public:
     ...
     top(sc_module_name name) : sc_module(name)
     {
       ...
       fifo_inst = new sc_fifo<char>("Fifo1", 10);
       //sc_fifo<char> char_fifo(10);//Make it a buffer of size 10 like before
       
       //cout << "before producer" << endl;
       prod_inst = new producer("Producer1");
       prod_inst->out(*fifo_inst);

       //cout << "before consumer" << endl;
